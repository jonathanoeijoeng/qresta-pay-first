...
new class extends Component {
    ...
    public function toggleAvailability($menuId)
    {
        ...
        $this->dispatch('toast', type: 'success', text: "Menu {$menu->name} kini " . ($menu->is_available ? 'tersedia' : 'tidak tersedia') . '.');
    ...
    <x-table :collection="$menus">
        <x-slot name="headers">
            ...
            <x-sort-header field="is_available" label="Status" :sortField="$sortField" :sortDirection="$sortDirection"
                class="text-center" />
            @can('base price')
            <x-sort-header field="price" label="HPP" :sortField="$sortField" :sortDirection="$sortDirection"
                class="text-right" />
            @endcan
        ...
        <x-table.row>
            ...
            <x-table.cell class="text-center">
                ...
                <x-toggle :checked="$menu->branch_is_available" wire:click="toggleAvailability({{ $menu->id }})" />
            </x-table.cell>
            @can('base price')
